    ...
    function a(e, t, r, n) {
      ...
      return e || (l = !1,
        ...
        e && (d ? h = r ? e : s && s.normalize ? s.normalize(e, function (e) {
          return i(e, p, n)
        }) : e.indexOf("!") === -1 ? i(e, p, n) : e : (h = i(e, p, n),
          c = o(h),
          d = c[0],
          h = c[1],
          r = !0,
    ...
    function f(e, t, i) {
      ...
      e.error ? e.emit("error", e.error) : (t[r] = !0,
        each(e.depMaps, function (r, n) {
          var o = r.id
            , a = getOwn(S, o);
          !a || e.depMatched[n] || i[o] || (getOwn(t, o) ? (e.defineDep(n, j[o]),
            e.check()) : f(a, t, i))
        }),
        i[r] = !0)
    }
            ...
            if (e.enabled && (i.isDefine || s.push(e),
              ...
              if (!e.inited && o)
                n(c) ? (t = !0,
                  u = !0) : (a.push(c),
                    r(c));
              else if (!e.inited && e.fetched && i.isDefine && (u = !0,
                !i.prefix))
                return d = !1
          }),
          o && a.length)
          ...
          this.depMaps.push(r),
            u(r, "defined", bind(this, function (r) {
              ...
              return this.map.unnormalized ? (r.normalize && (l = r.normalize(l, function (e) {
                ...
                d = getOwn(S, o.id),
                void (d && (this.depMaps.push(o),
                  this.events.error && d.on("error", bind(this, function (e) {
                    this.emit("error", e)
                  })),
                  d.enable()))) : f ? (this.map.url = q.nameToUrl(f),
        ...
        makeRequire: function (t, n) {
          function o(i, r, u) {
            ...
            return n.enableBuildCallback && r && isFunction(r) && (r.__requireJsBuild = !0),
              "string" == typeof i ? isFunction(r) ? c(makeError("requireargs", "Invalid require call"), u) : t && hasProp(E, i) ? E[i](S[t.id]) : req.get ? req.get(q, i, t, o) : (p = a(i, t, !1, !0),
                d = p.id,
                hasProp(j, d) ? j[d] : c(makeError("notloaded", 'Module name "' + d + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])")))) : (v(),
                  q.nextTick(function () {
                    v(),
                      f = s(a(null, t)),
                      f.skipMap = n.skipMap,
          ...
          return n = n || {},
            mixin(o, {
              ...
              toUrl: function (e) {
                ...
                return n !== -1 && (!a || n > 1) && (r = e.substring(n, e.length),
                  e = e.substring(0, n)),
            ...
            t || (o.undef = function (e) {
              ...
              n.undefed = !0,
                ...
                n && (n.events.defined && (M[e] = n.events),
                  p(e))
            }
            ),
            o
