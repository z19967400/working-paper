...
function GetMyCreditor(creditor_type:string){
  return new Promise((resolve, reject) => {
    http("get",url.GetMyCreditor,{creditor_type}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function getAllRegion(){
  return new Promise((resolve, reject) => {
    http("get",url.getAllRegion,{}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function getAllCurrency(){
  return new Promise((resolve, reject) => {
    http("get",url.getAllCurrency,{}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function saveCCreditor(parmas:any){
  return new Promise((resolve, reject) => {
    http("post",url.saveCCreditor,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function updateCreditor(parmas:any){
  return new Promise((resolve, reject) => {
    http("post",url.updateCreditor,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function Recognitiion(parmas:any){
  return new Promise((resolve, reject) => {
    http("post",url.Recognitiion,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function CreateAiOrder(parmas:any){
  return new Promise((resolve, reject) => {
    http("post",url.CreateAILawyerLetter,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function GetWeChatConfig(path:string){
  return new Promise((resolve, reject) => {
    http("post",url.GetWeChatConfig,{url:path}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function GetOrderDetails(pay_number:string){
  return new Promise((resolve, reject) => {
    http("get",url.GetOrderDetails,{pay_number}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function getOpenId(code:string){
  return new Promise((resolve, reject) => {
    http("get",url.getOpenId,{code}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function getOrderList(params:any){
  return new Promise((resolve, reject) => {
    http("get",url.getOrderList,params).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function getOrderInfo(debtor_number:string){
  return new Promise((resolve, reject) => {
    http("get",url.getOrderInfo,{debtor_number}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function StopOrder(params:any){
  return new Promise((resolve, reject) => {
    http("get",url.StopOrder,params).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function UserEdit(parmas:any){
  return new Promise((resolve, reject) => {
    http("post",url.UserEdit,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function Createcase(parmas:any){
  return new Promise((resolve, reject) => {
    http("post",url.CreateCase,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function getLawyerCases(parmas:any){
  return new Promise((resolve, reject) => {
    http("get",url.getLawyerCases,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function getLawyerCaseMatters(parmas:any){
  return new Promise((resolve, reject) => {
    http("get",url.getLawyerCaseMatters,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function GetLawyerCaseStatus(debtor_number:string){
  return new Promise((resolve, reject) => {
    http("get",url.GetLawyerCaseStatus,{debtor_number}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function GetCaseCourt(debtor_number:string){
  return new Promise((resolve, reject) => {
    http("get",url.GetCaseCourt,{debtor_number}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
...
function GetCaseMattersFromDetails(matters_from_id:string){
  return new Promise((resolve, reject) => {
    http("get",url.GetCaseMattersFromDetails,{matters_from_id}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
...
function ContractNotice(contract_id:string){
  return new Promise((resolve, reject) => {
    http("get",url.ContractNotice,{contract_id}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
...
function ContractSee(contract_id:string){
  return new Promise((resolve, reject) => {
    http("get",url.ContractSee,{contract_id}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
...
function GetCaseDetails(debtor_number:string){
  return new Promise((resolve, reject) => {
    http("get",url.GetCaseDetails,{debtor_number}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function ServiceFeeSelection(parmas:any){
  return new Promise((resolve, reject) => {
    http("get",url.ServiceFeeSelection,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function CreateQueryQrchives(parmas:any){
  return new Promise((resolve, reject) => {
    http("post",url.CreateQueryQrchives,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function CreateLitigationFunding(parmas:any){
  return new Promise((resolve, reject) => {
    http("post",url.CreateLitigationFunding,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function CreatePreservationInsurance(parmas:any){
  return new Promise((resolve, reject) => {
    http("post",url.CreatePreservationInsurance,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function GetServicesPagingData(parmas:any){
  return new Promise((resolve, reject) => {
    http("get",url.GetServicesPagingData,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
 ...
 */
 function GetServiceDetails(parmas:any){
  return new Promise((resolve, reject) => {
    http("get",url.GetServiceDetails,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
...
function GetAddressDetails(parmas:any){
  return new Promise((resolve, reject) => {
    http("post",url.GetAddressDetails,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
...
function UrlClicksCount(debtor_number:any){
  return new Promise((resolve, reject) => {
    http("get",url.UrlClicksCount,{debtor_number}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
...
function GetLogisticsByDebtorNumber(debtor_number:any){
  return new Promise((resolve, reject) => {
    http("get",url.GetLogisticsByDebtorNumber,{debtor_number}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
...
function GetTaskContentById(parmas:any){
  return new Promise((resolve, reject) => {
    http("get",url.GetTaskContentById,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
...
function GenerateReport(id:number){
  return new Promise((resolve, reject) => {
    http("get",url.GenerateReport,{id}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
...
function GetAILawyerLetterReport(debtor_number:string){
  return new Promise((resolve, reject) => {
    http("get",url.GetAILawyerLetterReport,{debtor_number}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
...
function GetQuotedPriceByDebtorNumber(debtor_number:string){
  return new Promise((resolve, reject) => {
    http("get",url.GetQuotedPriceByDebtorNumber,{debtor_number}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
...
function CustomerSelectQuotedPrice(parmas:any){
  return new Promise((resolve, reject) => {
    http("get",url.CustomerSelectQuotedPrice,parmas).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
...
function GetByid(id:number){
  return new Promise((resolve, reject) => {
    http("get",url.GetByid,{id}).then(res => {
      resolve (res);
    },error => {
      console.log("网络异常~",error);
      reject(error)
