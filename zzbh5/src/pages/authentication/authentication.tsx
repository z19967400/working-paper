  ...
  constructor(props:any){
    ...
    this.state = {
      ...
      enterprise:[
        ...
        {label:'代理人姓名',value:'',isRequired:true,prop:'agent_name',disabled:false},
        {label:'代理人身份证号',value:'',isRequired:true,prop:"agent_id_number",disabled:false},
        {label:'代理人手机号码',value:'',isRequired:true,prop:'phone_number',disabled:false},
        {label:'代理人电子邮箱',value:'',isRequired:false,prop:'email',disabled:false}
      ],
      key:0,
      creditor_id:0,
      confirm:false,
