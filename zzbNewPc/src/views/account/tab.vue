<template>
  <div class="table-wrap">
    ...
    <el-table border id="comTable" :height="height" v-loading="data.loading" :data="data.Data" style="width: 100%" highlight-current-row fixed>
      ...
      <el-table-column v-if="operation" fixed="right" width="220px" label="操作">
        <template slot-scope="scope">
          <el-button class="info" type="text" size="small" @click="handleAdmin(scope.$index, scope.row)">管理员设置</el-button>
