    ...
    <div class="content">
      <div class="box">
        <el-row type="flex" align="middle">
          ...
          <el-col :span="14">
            <el-input style="width:330px;" placeholder="请输入" v-model="data.name"></el-input>
          </el-col>
        </el-row>
        <el-row type="flex" align="middle">
          <el-col :span="2">
        ...
        <el-row type="flex" align="middle">
          ...
          <el-col :span="14">
            <el-checkbox-group v-model="data.a_type">
              <el-checkbox v-for="(item,index) in searchTypes" :key="index" :label="item">{{item}}</el-checkbox>
            </el-checkbox-group>
          </el-col>
        </el-row>
        <el-row type="flex" align="middle">
          ...
          <el-col :span="14">
            <el-input style="width:500px;" type="textarea" rows="4" placeholder="“查档类型”选择“其他类型”时请填写补充说明" v-model="data.a_type_01">
            </el-input>
          </el-col>
        </el-row>
        <el-row type="flex">
          ...
          <el-col :span="14">
            <el-checkbox-group @change="handChange" v-model="data.information_01">
              <el-checkbox v-for="(item,index) in information" :key="index" :label="item">{{item}}</el-checkbox>
            </el-checkbox-group>
          </el-col>
        </el-row>
            ...
            <el-col v-for="(item, index) in replenish" :key="index" :span="12">
              <div v-if="item.name === '其他资料' && item.show">
                ...
                <el-col style="margin-top:10px;" :span="18">
                  <el-input style="width:330px;" type="textarea" rows="4" placeholder="“现有资料”选择“其他资料”时请填写" v-model="item.value">
                  </el-input>
                </el-col>
              </div>
              <div v-else-if="item.name === '当事人姓名' || item.name === '当事人身份证号'|| item.name === '当事人户籍地址'|| item.name === '房产具体地址' || item.name === '公司名称'">
                <el-col style="margin-top:10px;" v-show="item.show" :span="6">
                  <span class="lable">{{ item.name }}</span>
                </el-col>
                <el-col style="margin-top:10px;" v-show="item.show" :span="18">
                  <el-input style="width:330px;" placeholder="请输入" v-model="item.value">
                  </el-input>
                </el-col>
              </div>
              <div v-else-if="item.name === '法院立案通知书' || item.name === '执行通知书'|| item.name === '法院判决'|| item.name === '法院调查令' || item.name === '仲裁受理通知书'">
                <el-col style="margin-top:10px;" v-show="item.show" :span="6">
                  <span class="lable">{{ item.name }}</span>
                </el-col>
                <el-col style="margin-top:10px;" v-show="item.show" :span="18">
        ...
        <el-row type="flex" align="middle">
          ...
          <el-col :span="14">
            <el-input style="width:330px;" v-model="data.contacts_name" placeholder="请填写查询人的联系人姓名，以便联系"></el-input>
          </el-col>
        </el-row>
        <el-row type="flex" align="middle">
          <el-col :span="2">
          ...
          <el-col :span="14">
            <el-input style="width:330px;" v-model="data.contacts_telphone" placeholder="请填写查询人的联系人手机号，以便联系"></el-input>
          </el-col>
        </el-row>
        <el-row type="flex" align="middle">
          <el-col :span="2">
          ...
          <el-col :span="14">
            <el-input style="width:330px;" v-model="data.contacts_email" placeholder="请填写查询人的联系人邮箱，以便发送资料"></el-input>
          </el-col>
        </el-row>
        <el-row type="flex" align="middle">
          <el-col :span="2">
