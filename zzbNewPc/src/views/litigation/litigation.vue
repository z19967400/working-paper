    ...
    <div class="content">
      <div class="box">
        ...
        <el-row type="flex" align="middle">
          ...
          <el-col :span="4">
            <adress
              @emitAddress="emitAddress2"
              :address="data.other_jurisdictions"
            ></adress>
          </el-col>
        </el-row>
        <el-row type="flex" align="middle">
        ...
        <el-row type="flex" align="middle">
          ...
          <el-col :span="6">
            <el-select
              style="width:218px;"
              v-model="data.case_stage"
              placeholder="请选择案件阶段"
            >
              <el-option
                v-for="item in caseStage"
                :key="item.value"
                :label="item.label"
                :value="item.value"
              >
        ...
        <el-row type="flex" align="middle">
          ...
          <el-col :span="14">
            <el-input
              ...
              type="textarea"
              rows="4"
              placeholder="“案件阶段”选择“其他”时请补充说明"
              v-model="data.case_stage_explain"
            >
            </el-input>
          </el-col>
        </el-row>
