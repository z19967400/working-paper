    ...
    <div class="content">
      <div class="box">
        <el-row type="flex" align="middle">
          ...
          <el-col :span="6">
            <el-input style="width:330px;" v-model="data.applicant" placeholder="请填写财产保全申请人名称"></el-input>
          </el-col>
          <el-col :span="2">
            <span class="lable">
              财产保全被申请人
          ...
          <el-col :span="6">
            <el-input style="width:330px;" v-model="data.respondent" placeholder="请填写财产保全被申请人名称"></el-input>
          </el-col>
        </el-row>
        <el-row type="flex" align="middle">
          <el-col :span="2">
          ...
          <el-col :span="6">
            <el-input style="width:330px;" v-model="data.application_amount" placeholder="（元/人民币）"></el-input>
          </el-col>
        </el-row>
        <el-row type="flex" align="middle">
          <el-col :span="2">
