...
export default class About extends Vue {
  ...
  @Prop({ default: false }) public leftchoice?: boolean
  @Prop({ default: false }) public rightchoice?: boolean
  //watch
  @Watch('tableData')
  ...
  handleSelectionChange(val: any) {
    ...
    val.forEach((val: any, index: any) => {
      _this.tableData.forEach((v: any, i: any) => {
        // id 是每一行的数据id
        if (val.id == v.id) {
          choiceindex = i
        }
