    ...
    <div v-for="(item, index) in data.list" :key="index" class="cell">
      ...
      <div class="cell-top">
        ...
        <div class="cell-top-right">
          ...
          <p
            v-show="item.creditor_type != 'Creditor_states_1'"
          ...
          >
            ...
            <span class="value">{{ item.agent_id_number || '未填写' }}</span>
          </p>
          <p
            v-show="item.creditor_type == 'Creditor_states_1'"
            class="cell-top-right-row"
          ...
          <p class="cell-top-right-row">
            ...
            <span class="value">{{ item.audit_status }}</span>
          </p>
      ...
      <div v-if="item.admin_list.length > 0" class="cell-buttom">
        <!-- <el-button v-show="item.admin_list.length != data.adminList.length" type="primary" class="addButtom" size="small" @click="addAdmin(item)" icon="el-icon-circle-plus-outline" plain>新增授权管理员</el-button> -->
    ...
    >
      <div class="shenhe-box">
        <!-- <el-row>
          ...
          <el-col :span="12">
            <img class="img" @click="preview(shenhe.license_img_url)" :src="shenhe.license_img_url">
          </el-col>
        </el-row> -->
        <el-row>
