  ...
  >
    ...
    <div class="letter" v-show="data.flag">
      ...
      <el-row type="flex" align="middle">
        <el-col :span="2">选择用户及管理员</el-col>
        <el-col style="margin-right:30px;" :span="7">
          <div @click="changeDialogVisible2" class="select-zz">
            <span>{{ this.selectUsers }}</span>
      ...
      <el-row type="flex" align="middle">
        ...
        <el-col style="margin-right:30px;" :span="7">
          <div @click="changeDialogVisible" class="select-zz">
            <span>{{ this.selectCreditors }}</span>
            <span class="el-icon-arrow-down"></span>
          </div>
        </el-col>
        <!-- <el-col :span="3">
        ...
        <el-col :span="2" align="left">
          ...
          >
            <img
              ...
              src="../../../../assets/images/layout/tips.svg"
              alt=""
            />
          </el-tooltip>
        </el-col>
      ...
      <el-row type="flex" style="height:auto;" align="middle">
        ...
        <el-col :span="12">
          <el-upload
            drag
            :action="
              'https://api2.debteehelper.com/api/Upload/UploadImage?type=2'
            "
...
<script lang="ts" src="./createAIlawyer.ts"></script>

<style lang="scss">
@import './createAIlawyer.scss';
</style>
